...
definitions = SXP.read(elisp_definitions)[3]

unless definitions.is_a?(Array)
  raise RuntimeError, "No definitions found"
end

puts "Total definitions => " + definitions.count.to_s

processed = process_definition(definitions.first)
